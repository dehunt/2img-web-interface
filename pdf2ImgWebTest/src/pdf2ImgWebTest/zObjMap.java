...
public class zObjMap {
	String objectmapPath = "resources/objectmap.properties";
	Properties prop;
	
	// load objectmap.properties when constructed
	public zObjMap () {
		prop = new Properties();
		
		try {
			FileInputStream fis = new FileInputStream(objectmapPath);
			prop.load(fis);
			fis.close();
		}catch (IOException e) {
	...
	public By getLoc(String strElement) throws Exception {
